...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "naim") || (event.body.toLowerCase() == "nobita") || (event.body.toLowerCase() == "@FMZ NOBITA ──😘😈🪼🩶🪽😘 😈 😈 ☠️🌺😘😈") || (event.body.toLowerCase() == "নাইম")) {
     return api.sendMessage("নাইম বস এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘","প্রেম করবা নাকি😊এতো mentioned দাও কেনো","ইনবক্সে মেসেজ দিয়ে রাখো😊🫶কাজ শেষ হলে দেখবে",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ 𝗡𝗔𝗛𝗜𝗗𝗨𝗟 𝗜𝗦𝗟𝗔𝗠 𝗡𝗔𝗜𝗠 ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝗡𝗔𝗜𝗠.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/virtual.abbu.nobita\nতার সাতে যোগা যোগ করবেন WhatsApp :- +8801810769343", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "ayra") || (event.body.toLowerCase() == "আয়রা")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস নাইম এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@FMZ NOBITA ──😘😈🪼🩶🪽😘 😈 😈 ☠️🌺😘😈 ") || (event.body.toLowerCase() == "Naim")) {
   ...
   if ((event.body.toLowerCase() == "AMAKE KEW VALOBASHE NA") || (event.body.toLowerCase() == "amake kew valobashe na") || (event.body.toLowerCase() == "Aj kew nai bole")) {
     return api.sendMessage("️চিন্তা করো কেন আমি তো আছি🫶/nতোমাকে রাইতে ভালোবাসবে আমার বস নাইম https://www.facebook.com/virtual.abbu.nobita", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("জান‌ আমার বস নাইম এর সাথে সেক্স করবা🥵🥵 থুক্কু টেক্সট করবা 😪এই নাও আইডি লিংক https://www.facebook.com/NATOKBAZ.NAIM1🥱", threadID);
   };
